			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 gtco-heading text-center">
						<h2>Kategorije za koje mozete glasati</h2>
					</div>
				</div>
			</div>
            <div class="container">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(nizPodataka,function (i,podatak) {
                    ...
                    output += "<h2>Naziv kategorije: <span style='color: darkred; font-weight: bold'>" + podatak.nazivKategorije +"</span></h2>";
                    output += "<p>Opis kategorije: " + podatak.opisKategorije +"</p>";
                    output += "</div>";
                });

                $("#kategorije").html(output);
            }
        })
